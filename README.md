...
📄 Pega Blueprint - Movie Ticket Booking (BP-2415612)
📄 National Internship Program Project User Stories & Specifications
🎯 Key Objectives
...
👥 Personas & Channels (6)
Customer: Submits ticket requests, selects movie/timing/seats, and reviews/approves booking details.
Booking Agent: Verifies seating availability and assists in booking fulfillment.
Support Team: Handles customer inquiries and exceptions.
Premium Show Team: Manages premium / special screening booking queues (PremiumShowQueue).
Standard Show Team: Manages standard theatre screening booking queues (StandardShowQueue).
Application Control Agent: Oversees background automation, SLA tracking, and correspondence.
🗄️ Data Objects (6)
...
👨‍💻 Author & Repository
Author: Divya K (@Divyakrish-007)
Repository: Movie_Ticket_Booking
